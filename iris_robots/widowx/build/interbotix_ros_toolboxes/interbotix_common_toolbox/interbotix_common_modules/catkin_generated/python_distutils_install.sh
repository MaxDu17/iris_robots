...
echo_and_run cd "/iris/u/jyang27/dev/iris_robots/iris_robots/widowx/src/interbotix_ros_toolboxes/interbotix_common_toolbox/interbotix_common_modules"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/iris/u/jyang27/dev/iris_robots/iris_robots/widowx/src/interbotix_ros_toolboxes/interbotix_common_toolbox/interbotix_common_modules/setup.py" \
     \
    build --build-base "/iris/u/jyang27/dev/iris_robots/iris_robots/widowx/build/interbotix_ros_toolboxes/interbotix_common_toolbox/interbotix_common_modules" \
    install \
    --root="${DESTDIR-/}" \
